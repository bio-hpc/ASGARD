...
class Target_one_query():
    ...
    def execute(self):
        ...
        if self.cfg.target_chains == "1":                                       # target con un a cadena
            ...
            file_query = self.cfg.dir_queries
            
            self.cfg.dir_queries = os.path.dirname(self.cfg.dir_queries)+"/"
            ...
            file_query = self.cfg.dir_queries #mapeo del fichero
            self.cfg.dir_queries = os.path.dirname(self.cfg.dir_queries) + "/" #mapeo al directorio de la molecula
            name_query, ext_query = os.path.splitext(os.path.basename(file_query))
            cnt_letter = 97
