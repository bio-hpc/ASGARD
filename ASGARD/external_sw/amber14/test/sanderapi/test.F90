...
subroutine check_for_slko(failed)
    ...
    open(unit=10, file="../../dat/slko/C-C.skf", status='OLD', iostat=ierror)
...
program test_program
    ...
    write(6, '(a)') 'Checking proper treatment of a bad prmtop'
    ...
    write(6, '(a)') 'Checking proper treatment of bad input'
    options%cut = -1.0
