...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  function rism1d_kh_exchem_PR(this, gvv, cvv, mtv, jvv, rhov, dr) result(exchem)
...
!!!   dr   : r-space grid spacing
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  function rism1d_kh_exchem_r(this, gvv, cvv, mtv, jvv, rhov, dr) result(exchem)
    use constants, only : pi
    implicit none
    type(rism1d_kh), intent(in) :: this
    _REAL_, intent(in) :: gvv(:,:),cvv(:,:), rhov(:), dr
...
!!!   dr   : r-space grid spacing
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  function rism1d_kh_exchemIon(this, gvv, cvv, mtv, jvv, rhov, dr) result(exchem)
    use constants, only : pi
    implicit none
    type(rism1d_kh), intent(in) :: this
    _REAL_, intent(in) :: gvv(:,:),cvv(:,:), rhov(:), dr
