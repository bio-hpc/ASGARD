...
class RISMout(AmberOutput):
   ...
   def _get_energies(self, outfile):
      ...
      while rawline:
         ...
         elif self.solvtype == 0 and rawline[0:11] == 'rism_exchem':
            self.data['ERISM'].append(float(rawline.split()[1]))
         elif self.solvtype == 1 and rawline[0:11] == 'rism_exchGF':
            self.data['ERISM'].append(float(rawline.split()[1]))
...
class PolarRISMout(RISMout):
   ...
   def _get_energies(self, outfile):
      ...
      while rawline:
         ...
         elif self.solvtype == 0 and rawline[0:10] == 'rism_polar':
            self.data['POLAR SOLV'].append(float(rawline.split()[1]))
         elif self.solvtype == 0 and rawline[0:11] == 'rism_apolar':
            self.data['APOLAR SOLV'].append(float(rawline.split()[1]))
         elif self.solvtype == 1 and rawline[0:10] == 'rism_polGF':
            self.data['POLAR SOLV'].append(float(rawline.split()[1]))
         elif self.solvtype == 1 and rawline[0:11] == 'rism_apolGF':
            self.data['APOLAR SOLV'].append(float(rawline.split()[1]))
