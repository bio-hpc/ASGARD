...
int mg_rotate_desc()
{
	...
	extern int mg_rotate_compute();

	AVSset_module_name( "mg_rotate", MODULE_DATA );
	...
	param = AVSadd_float_parameter( "Angle", 0.00000,
	...
	AVSset_compute_proc( mg_rotate_compute );
	return( 1 );
}
...
/* *****************************************/
int mg_rotate_compute(
	InMatrices, OutMatrices,
	o_Center, o_Axis, o_Angle,
	Axestype, Center, Axis, Angle, Name
)
