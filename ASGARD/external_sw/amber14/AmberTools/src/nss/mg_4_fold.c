...
int mg_4_fold_desc()
{
	...
	extern int mg_4_fold_compute();

	AVSset_module_name( "mg_4_fold", MODULE_DATA );
	...
	AVSset_compute_proc( mg_4_fold_compute );
	return( 1 );
}
...
/* *****************************************/
int mg_4_fold_compute( InMatrices, OutMatrices,
