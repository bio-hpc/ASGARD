...
/*  Module Description                     */
/* *****************************************/
int mg_translate_desc()
{

	int in_port, out_port, param, iresult;
	extern int mg_translate_compute();

	AVSset_module_name( "mg_translate", MODULE_DATA );
	...
	param = AVSadd_float_parameter( "Dist", 0.00000,
	...
	AVSset_compute_proc( mg_translate_compute );
	return( 1 );
}
...
/* *****************************************/
int mg_translate_compute(
	InMatrices, OutMatrices,
	o_Center, o_Axis, o_Dist,
	Axestype, Center, Axis, Dist, Name
)
