...
int mg_tetra_desc()
{
	...
	extern int mg_tetra_compute();

	AVSset_module_name( "mg_tetra", MODULE_DATA );
	...
	AVSset_compute_proc( mg_tetra_compute );
	return( 1 );
}
...
/* *****************************************/
int mg_tetra_compute(
	InMatrices, OutMatrices,
	o_noID, o_Center, o_Axis1, o_Axis2,
	noID, Axestype, Center, Axis1, Axis2, Name
)
