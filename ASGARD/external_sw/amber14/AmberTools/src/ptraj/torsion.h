 ...
 *  CVS tracking:
 *
 *  $Header: /home/case/cvsroot/amber11/AmberTools/src/ptraj/torsion.h,v 10.0 2008/04/15 23:24:11 case Exp $
 *
...
/* Header file for torsion.c */

#ifndef TORSION_MODULE
#  ifdef __STDC__
...
double puckercp(double x1, double y1, double z1,
		double x2, double y2, double z2,
		double x3, double y3, double z3,
		double x4, double y4, double z4,
		double x5, double y5, double z5, double *amplitude);

double puckeras(double x1, double y1, double z1,
		double x2, double y2, double z2,
		double x3, double y3, double z3,
		double x4, double y4, double z4,
		double x5, double y5, double z5, double *amplitude);
