 ...
 *  CVS tracking:
 *
 *  $Header: /home/case/cvsroot/amber11/AmberTools/src/ptraj/experimental.h,v 10.0 2008/04/15 23:24:11 case Exp $
 *
...
/* Header file for experimental.c */

#ifndef EXPERIMENTAL_MODULE
#  ifdef __STDC__

extern Parm *   modifyTIP3P(int);
extern void     testWater();
extern void     checkGrid(char *);

#  else

extern Parm *   modifyTIP3P();
extern void     testWater();
extern void     checkGrid();
#  endif
#endif
