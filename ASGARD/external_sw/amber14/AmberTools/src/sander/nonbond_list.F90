...
subroutine nonbond_list(crd,iac,ico,iblo,inb,ntypes, &
      natom,x,ix, &
      ipairs,ntnb,ibelly,belly,newbalance, &
      qsetup,&
      do_list_update)
#ifdef MPI
...
!----------------------------------------------------------------------------
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!+ build the nonbond list.
subroutine get_nb_list(iac, ico, ntypes, ifail, &
      listtot, natom, ipairs, nghbptr, &
      nghtran, tranvec, belly, ibelly, &
      balance, gridpairs, periodic, nogrdptrs)
...
!   integer ichk
   ...
   do i = 1,natom
         i1 = int((fraction(1,i) + shft) * dble(nucgrd1)) + 1
         i2 = int((fraction(2,i) + shft) * dble(nucgrd2)) + 1
         i3 = int((fraction(3,i) + shft) * dble(nucgrd3)) + 1
