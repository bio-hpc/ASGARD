...
include(dot-common.m4)dnl
dnl 
dnl
dnl  Usage:
dnl    DOT        ($1, $2, $3, $4)
dnl    DOT_HEAD   ($1, $2, $3, $4)
dnl    DOT_NAME   ($1, $2, $3, $4)
dnl    DOT_PARAMS ($1, $2, $3, $4)
dnl    DOT_COMMENT($1, $2, $3, $4)
dnl
...
define(`SWITCH_prec', `
  ...
  case blas_prec_extra:
    { DOT_BODY($1, $2, $3, $8, $9, FPU) }
    break;
 }')dnl
dnl
dnl
dnl  Usage: DOT_X_BODY($1, $2, $3)
...
define(`DOT', 
  `DOT_HEAD($1, $2, $3, $4)
   DOT_COMMENT($1, $2, $3, $4)
   {
     static const char routine_name[] = "DOT_NAME($1, $2, $3, $4)";
     ifelse($4, _x, `DOT_X_BODY($1_type, $2_type, $3_type)', 
