dnl ---------------------------------------------------------
dnl  SYMM ---- Symmetric Matrix Multiply
dnl
...
include(symm-common.m4)dnl
dnl
dnl
dnl  Usage:
dnl    SYMM        ($1, $2, $3, $4)
dnl    SYMM_HEAD   ($1, $2, $3, $4)
dnl    SYMM_NAME   ($1, $2, $3, $4)
dnl    SYMM_PARAMS ($1, $2, $3, $4)
dnl    SYMM_COMMENT($1, $2, $3, $4)
dnl
...
dnl
dnl
dnl Usage:  SYMM_BODY($1, $2, $3, $4, $5, $6)
...
define(`SYMM', 
  `SYMM_HEAD($1, $2, $3, $4) 
   SYMM_COMMENT($1, $2, $3, $4)
  {
    ifelse($4, `_x', `SYMM_X_BODY($1_type, $2_type, $3_type)', 
      `SYMM_BODY($1_type, $2_type, $3_type, 
