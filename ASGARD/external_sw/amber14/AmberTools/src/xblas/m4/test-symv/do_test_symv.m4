dnl Generates test code for symv
#include <stdlib.h>
#include <stdio.h>
#include <math.h>
...
include(symv/symv-common.m4)dnl
dnl
dnl
define(`DO_TEST_SYMV_NAME', 
  `ifelse(`$1&&$1', `$2&&$3', `do_test_$1symv$4', `do_test_$1symv_$2_$3$4')')
dnl
dnl
define(`DO_TEST_SYMV_PARAMS', 
  `int n,  
...
dnl
dnl
define(`DO_TEST_SYMV_HEAD', 
  `void DO_TEST_SYMV_NAME($1, $2, $3, $4) 
           (DO_TEST_SYMV_PARAMS($1, $2, $3, $4))')
dnl
dnl
define(`DO_TEST_SYMV', 
  `DO_TEST_SYMV_HEAD($1, $2, $3, $4) {
   DO_TEST_SYMV_BODY($1, $2, $3, $4)
  }')
dnl
dnl
dnl
define(`TESTGEN_SYMV_NAME', `ifelse(
       `$2&&$3', `$1&&$1', `BLAS_$1symv_testgen', `BLAS_$1symv_$2_$3_testgen')')
dnl
dnl
define(`DO_TEST_SYMV_BODY', 
  `
  /* Function name */
  const char fname[] = "SYMV_NAME($1, $2, $3, $4)";
  ...
  *max_ratio = 0.0;
  ...
  MALLOC_VECTOR(a, $2_type, 2 * n_i * n_i * n_i)
                    ...
                    for (incx_val = INCX_START; incx_val <= INCX_END; incx_val++) {
                      ...
                      for (incy_val = INCY_START; incy_val <= INCY_END; incy_val++) {
                        ...
                        for (randomize_val = RANDOMIZE_START; 
                            ...
                            TESTGEN_SYMV_NAME($1, $2, $3) (norm, order_type, 
                              uplo_type, n, randomize_val, &alpha, 
                              alpha_flag, &beta, beta_flag, a, lda, x, incx, 
                            ...
                            FPU_FIX_STOP;
                            SYMV_NAME($1, $2, $3, $4)(order_type,
                              uplo_type, n, alpha, a, lda, x, incx, beta, 
                            ...
                            for (i = 0, yi = y_starti, ri = 0; 
                              ...
                              $2sy_copy_row(order_type, uplo_type, 
                                              n_i, a, lda, a_vec, i);   
...
dnl
dnl
define(`CALL_DO_TEST_SYMV', 
 `fname = "SYMV_NAME($1, $2, $3, $4)";
  printf("Testing %s...\n", fname);
  total_tests = 0;
  total_bad_ratios = 0;
  ...
  for (i = 0; i < nsizes; i++) {
    ...
    DO_TEST_SYMV_NAME($1, $2, $3, $4)(n, ntests, &seed, thresh, debug,
             test_prob,   
