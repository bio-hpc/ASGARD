 ...
 */
   {
     static const char routine_name[] = "BLAS_cgemv";
  ...
  if (beta_i[0] == 0.0 && beta_i[1] == 0.0) {
    ...
    if ((alpha_i[0] == 1.0 && alpha_i[1] == 0.0)) {
      ...
      for (i=0; i<leny; i++) {
        ...
        jx = kx;
        for (j=0; j<lenx; j++) {
          a_elem[0] = a_i[aij]; a_elem[1] = a_i[aij+1];
          a_elem[1] = - a_elem[1];
          x_elem[0] = x_i[jx]; x_elem[1] = x_i[jx+1];
          {
