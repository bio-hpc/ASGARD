/*!
   \file commLineOptions.h

   \brief Command line class for c++ code

*/

#ifndef COMMLINEOPTIONS_H
#define COMMLINEOPTIONS_H
...
protected: /* the hidden data structure */
