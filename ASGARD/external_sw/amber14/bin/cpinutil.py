#!/mnt/home/soft/python/programs/x86_64/bin/python2.7
...
try:
    ...
    from chemistry.exceptions import ChemError, CpinInputError
...
def main(opt):
    ...
    if resnames is not None and notresnames is not None:
        raise CpinInputError('Cannot specify -resnames and '
                             '-notresnames together')
