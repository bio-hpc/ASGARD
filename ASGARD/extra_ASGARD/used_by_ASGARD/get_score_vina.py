...
#       Fecha:   3/3/2017
#       version: 1
#       Usage:  Se le pasa por parametro una proteina un ligando, y genera el score mediante vina
#       depende de:
#           ShuttleMol/extra_shuttlemol/used_by_shuttlemol/convert_to.py
#           ShuttleMol/external_sw/autodock/vina
#
...
import os
import subprocess
VINA_RUN_SCORE_ONLY = "ShuttleMol/external_sw/autodock/vina --score_only --receptor {} --ligand {}"
