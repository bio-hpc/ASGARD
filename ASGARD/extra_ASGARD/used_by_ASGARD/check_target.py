...
# -*- coding: utf-8 -*-
#
#       Cheackquea que los atomos de la proteina sean correctos y no falten en la cadena
#       return:
#             true si la proteina es correcta
#             False y atomos rotos
#
#       dependency:
...
standar_file_coords = "ASGARD/extra_ASGARD/used_by_ASGARD/standar_file_coords.py"
