...
#       Fecha:   3/3/2017
#       version: 1
#       Usage:  Se le pasa por parametro una proteina un ligando, una salida y genera poseview
#       depende de:
#           ShuttleMol/extra_shuttlemol/used_by_shuttlemol/convert_to.py
#
try:
...
CONVERT_TO = '{} {} {} {} -b'
POSEVIEW_DIR = "ShuttleMol/external_sw/poseview/"
...
def parse_poseview_log(out_poseview):
    ...
    for score in scores:
        ...
        # Ignorar la línea resumen
        if score[0].lower() == 'total':
            continue
        # Agrupar las líneas que no tienen score propio
...
if __name__ == "__main__":
    ...
    #
    #   en caso de que receptor o ligando no seqan pdb se transforma
    #
