...
SCRIPT_FILETER_COLUMNNS=${path_extra_shuttlemol}/used_by_shuttlemol/filter_columns_distance_dd.py
...
execute_script()
{
	...
	execute "${PYTHON_RUN} ${SCRIPT_FILETER_COLUMNNS} ${target} ${DRAGON_OUT} ${OUT_MOLEC} $opt_aux"
}
