...
class GraphsInteractionsTargetQueries:
    """
    ...
    def generate_graph(self):
        ...
        if not self.cfg.p_sequential:
            dependencies = self.cfg.lstJobs[-1]
        ...
        for i_mol in range(1, len(self.cfg.lst_molecules)):
            ...
            if self.cfg.p_interactions_gromacs:
                ...
                # add the group line which checks the energies in rerun step
    ...
    def generate_index(self):
        ...
        cmd = '{} {} -f {} -o {} -n {} < {}'.format(self.cfg.gromacs, self.cfg.graph + "make_ndx" + self.cfg.mpi,
                                                    self.cfg.gro_md, self.index_all_residues, self.index_all_residues,
                                                    self.input_file_tmp)
