...
#        round(np.var(i[1].lst_lj), round_decimals),
#
#        round(i[1].avarage_coul, round_decimals),
#        round(np.var(i[1].lst_coul), round_decimals),
#
#        round(i[1].avarage_all, round_decimals),
#        round(np.var(i[1].lst_all), round_decimals),
#
#        round(i[1].last_all, round_decimals)
#        ))
#    sum_fileds[0] += i[1].avarage_lj
#    sum_fileds[1] += np.var(i[1].lst_lj)
#    sum_fileds[2] += i[1].avarage_coul
#    sum_fileds[3] += np.var(i[1].lst_coul)
#    sum_fileds[4] += i[1].avarage_all
#    sum_fileds[5] += np.var(i[1].lst_all)
